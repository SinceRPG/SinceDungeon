 ...
 * Provides exceptionally detailed Editor Prompts for the best UI/UX experience.
 */
public class PremiumLanguageInjector {
    ...
    public static void inject(SinceDungeon core) {
        ...
        if (editorCfg != null) {
            ...
            // Existing Premium Actions (Abbreviated to save length, assumes previously injected ones remain...)
