...
public class EditorSession {
    ...
    public enum SettingOption {
        ...
        DEDUCT_LIVES_ON_LEAVE("settings.lives-deducted-on-leave", null, Material.OAK_DOOR, "setting_deduct_lives_leave", "INT", 0),
        DEDUCT_LIVES_ON_FAIL("settings.lives-deducted-on-fail", null, Material.CRYING_OBSIDIAN, "setting_deduct_lives_fail", "INT", 0),
        DEDUCT_LIVES_ON_CLEAR("settings.lives-deducted-on-clear", null, Material.EMERALD_BLOCK, "setting_deduct_lives_clear", "INT", 0),
